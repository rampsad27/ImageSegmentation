...
!(function () {
  ...
  var b = function (a) {
    ...
    (this.provider =
      "undefined" != typeof b.provider ? b.provider : c.provider),
      (this.maxLength =
        "undefined" != typeof b.maxLength ? b.maxLength : c.maxLength),
      (this.onUpdate =
        "undefined" != typeof b.onUpdate ? b.onUpdate : c.onUpdate),
  ...
  (b.prototype.initialize = function (a) {
    ...
    "undefined" != typeof window && (window.SimpleUndo = b);
})(),
  (window.DrawingBoard =
    "undefined" != typeof DrawingBoard ? DrawingBoard : {}),
  (DrawingBoard.Utils = {}),
  ...
  (DrawingBoard.Utils._boxBorderSize = function (a, b, c, d) {
    ...
    var e,
      f = 0;
    "width" == d
      ? ((e = ["border-left-width", "border-right-width"]),
        b && e.push("padding-left", "padding-right"),
        c && e.push("margin-left", "margin-right"))
      : ((e = ["border-top-width", "border-bottom-width"]),
        b && e.push("padding-top", "padding-bottom"),
        c && e.push("margin-top", "margin-bottom"));
    for (var g = e.length - 1; g >= 0; g--)
      f += parseInt(a.css(e[g]).replace("px", ""), 10);
    return f;
  }),
  ...
  (DrawingBoard.Utils.isColor = function (a) {
    return a && a.length
      ? /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(a) ||
          -1 !== $.inArray(a.substring(0, 3), ["rgb", "hsl"])
      : !1;
  }),
  ...
  (window.DrawingBoard =
    "undefined" != typeof DrawingBoard ? DrawingBoard : {}),
  (DrawingBoard.Board = function (a, b) {
    if (
      ((this.opts = this.mergeOptions(b)),
    ...
    return (
      this.opts.controlsPosition.indexOf("bottom") > -1
        ? (c += '<div class="drawing-board-controls"></div>')
        : (c = '<div class="drawing-board-controls"></div>' + c),
      this.$el.addClass("drawing-board").append(c),
      (this.dom = {
      ...
      $.each(
        ["left", "right", "center"],
        $.proxy(function (a, b) {
          return this.opts.controlsPosition.indexOf(b) > -1
            ? (this.dom.$controls.attr("data-align", b), !1)
            : void 0;
        }, this)
      ),
      ...
      this.ctx
        ? ((this.storage = this._getStorage()),
          this.initHistory(),
          this.reset({ webStorage: !1, history: !1, background: !1 }),
          this.initControls(),
          this.resize(),
          this.reset({ webStorage: !1, history: !1, background: !0 }),
          this.restoreWebStorage(),
          this.initDropEvents(),
          void this.initDrawEvents())
        : (this.opts.errorMessage && this.$el.html(this.opts.errorMessage), !1)
    );
  }),
  ...
  (DrawingBoard.Board.prototype = {
    mergeOptions: function (a) {
      return (
        (a = $.extend({}, DrawingBoard.Board.defaultOpts, a)),
        a.background ||
          "background" !== a.eraserColor ||
          (a.eraserColor = "transparent"),
        a
      );
    },
    reset: function (a) {
      (a = $.extend(
        ...
        a.size && (this.ctx.lineWidth = a.size),
        (this.ctx.lineCap = "round"),
        (this.ctx.lineJoin = "round"),
        a.webStorage && this.saveWebStorage(),
        a.history && !a.background && this.saveHistory(),
    ...
    resize: function () {
      ...
      var a,
        ...
        c = [
          ...
          DrawingBoard.Utils.boxBorderWidth(this.dom.$canvasWrapper, !0, !0),
        ],
        d = [
          this.$el.height(),
          DrawingBoard.Utils.boxBorderHeight(this.$el),
          this.dom.$controls.height(),
          DrawingBoard.Utils.boxBorderHeight(this.dom.$controls, !1, !0),
          DrawingBoard.Utils.boxBorderHeight(this.dom.$canvasWrapper, !0, !0),
        ],
        e = function (a, b) {
          b = b || 1;
      ...
      this.opts.enlargeYourContainer
        ? ((a = this.$el.width()),
          (b = this.$el.height()),
          this.$el.width(e(c)),
          this.$el.height(e(d)))
        : ((a = f(c)), (b = f(d))),
        this.dom.$canvasWrapper.css("width", a + "px"),
        this.dom.$canvasWrapper.css("height", b + "px"),
        this.dom.$canvas.css("width", a + "px"),
        this.dom.$canvas.css("height", b + "px"),
        (this.canvas.width = a),
    ...
    initControls: function () {
      if (
        ((this.controls = []),
        !this.opts.controls.length || !DrawingBoard.Control)
      )
        return !1;
      for (var a = 0; a < this.opts.controls.length; a++) {
        var b = null;
        if ("string" == typeof this.opts.controls[a])
          b = new window.DrawingBoard.Control[this.opts.controls[a]](this);
        else if ("object" == typeof this.opts.controls[a]) {
          for (var c in this.opts.controls[a]) break;
          b = new window.DrawingBoard.Control[c](
            this,
            this.opts.controls[a][c]
          );
        }
        b && this.addControl(b);
      }
    ...
    addControl: function (a, b, c) {
      if (
        "string" != typeof a &&
        ("object" != typeof a || !a instanceof DrawingBoard.Control)
      )
        return !1;
      var d = "object" == typeof b ? b : {};
      (c = c ? 1 * c : "number" == typeof b ? b : null),
        "string" == typeof a &&
          (a = new window.DrawingBoard.Control[a](this, d)),
        c
          ? this.dom.$controls.children().eq(c).before(a.$el)
          : this.dom.$controls.append(a.$el),
    ...
    setImg: function (a, b) {
      b = $.extend({ stretch: this.opts.stretchImg, callback: null }, b);
      var c = this.ctx,
        d = new Image(),
      ...
      (d.onload = function () {
        (c.globalCompositeOperation = "source-over"),
          ...
          b.stretch
            ? c.drawImage(d, 0, 0, c.canvas.width, c.canvas.height)
            : c.drawImage(d, 0, 0),
          (c.globalCompositeOperation = e),
    ...
    saveWebStorage: function () {
      window[this.storage] &&
        (window[this.storage].setItem(
          "drawing-board-" + this.id,
          this.getImg()
        ),
        this.ev.trigger(
          "board:save" +
            this.storage.charAt(0).toUpperCase() +
    ...
    restoreWebStorage: function () {
      window[this.storage] &&
        null !== window[this.storage].getItem("drawing-board-" + this.id) &&
    ...
    _getStorage: function () {
      return !this.opts.webStorage ||
        ("session" !== this.opts.webStorage && "local" !== this.opts.webStorage)
        ? !1
        : this.opts.webStorage + "Storage";
    },
    initDropEvents: function () {
      return this.opts.droppable
        ? (this.dom.$canvas.on("dragover dragenter drop", function (a) {
            a.stopPropagation(), a.preventDefault();
          }),
          void this.dom.$canvas.on("drop", $.proxy(this._onCanvasDrop, this)))
        : !1;
    },
    ...
    setMode: function (a, b) {
      (b = b || !1),
        ...
        "transparent" === this.opts.eraserColor
          ? (this.ctx.globalCompositeOperation =
              "eraser" === a ? "destination-out" : "source-over")
          : ("eraser" === a
              ? "background" === this.opts.eraserColor &&
                DrawingBoard.Utils.isColor(this.opts.background)
                ? (this.ctx.strokeStyle = this.opts.background)
                : DrawingBoard.Utils.isColor(this.opts.eraserColor) &&
                  (this.ctx.strokeStyle = this.opts.eraserColor)
              : (this.mode && "eraser" !== this.mode) ||
                (this.ctx.strokeStyle = this.color),
            "filler" === a &&
              this.ev.bind("board:startDrawing", $.proxy(this.fill, this))),
        (this.mode = a),
        b || this.ev.trigger("board:mode", this.mode);
    },
    getMode: function () {
    ...
    setColor: function (a) {
      ...
      if (
        ((this.color = a),
        "transparent" !== this.opts.eraserColor && "eraser" === this.mode)
      ) {
        var c = function (a) {
          "eraser" !== a && (b.strokeStyle = b.color),
            b.ev.unbind("board:mode", c);
        };
    ...
    fill: function (a) {
      ...
      var c = this.ctx.getImageData(
        ...
        l = DrawingBoard.Utils.pixelAt(
          c,
          parseInt(a.coords.x, 10),
          parseInt(a.coords.y, 10)
        ),
        m = l[g],
      ...
      if (
        !DrawingBoard.Utils.compareColors(
          m,
          DrawingBoard.Utils.RGBToInt(i, j, k),
          n
        )
      ) {
        for (var p, q = [l], r = c.width - 1, s = c.height - 1; (p = q.pop()); )
          o && b(p),
            DrawingBoard.Utils.compareColors(p[g], m, n) &&
              (o || b(p),
              p[e] > 0 && q.push(DrawingBoard.Utils.pixelAt(c, p[e] - 1, p[f])),
              p[e] < r && q.push(DrawingBoard.Utils.pixelAt(c, p[e] + 1, p[f])),
              p[f] > 0 && q.push(DrawingBoard.Utils.pixelAt(c, p[e], p[f] - 1)),
              p[f] < s &&
                q.push(DrawingBoard.Utils.pixelAt(c, p[e], p[f] + 1)));
    ...
    _onInputStart: function (a, b) {
      (this.coords.current = this.coords.old = b),
        ...
        this.ev.trigger("board:startDrawing", { e: a, coords: b }),
        a.stopPropagation(),
        a.preventDefault();
    },
    _onInputMove: function (a, b) {
      (this.coords.current = b),
        this.ev.trigger("board:drawing", { e: a, coords: b }),
        window.requestAnimationFrame || this.draw(),
        a.stopPropagation(),
        a.preventDefault();
    },
    _onInputStop: function (a, b) {
      !this.isDrawing ||
        ...
        this.saveWebStorage(),
        this.saveHistory(),
        this.ev.trigger("board:stopDrawing", { e: a, coords: b }),
        this.ev.trigger("board:userAction"),
        a.stopPropagation(),
        a.preventDefault());
    },
    _onMouseOver: function (a, b) {
      (this.isMouseHovering = !0),
        ...
        this.ev.trigger("board:mouseOver", { e: a, coords: b });
    },
    _onMouseOut: function (a, b) {
      (this.isMouseHovering = !1),
        this.ev.trigger("board:mouseOut", { e: a, coords: b });
    },
    _getInputCoords: function (a) {
      ...
      return (
        a.touches && 1 == a.touches.length
          ...
          : ((b = a.pageX), (c = a.pageY)),
        (b -= this.dom.$canvas.offset().left),
        (c -= this.dom.$canvas.offset().top),
        (b *= e / d.width),
        (c *= f / d.height),
        { x: b, y: c }
      );
  ...
  (DrawingBoard.Control = function (a, b) {
    return (
      ...
      this.name && this.$el.addClass("drawing-board-control-" + this.name),
  ...
  (DrawingBoard.Control.Color = DrawingBoard.Control.extend({
    ...
    initialize: function () {
      ...
      this.$el.on(
        ...
        $("body").on("click", function (b) {
          var c = $(b.target),
            d = c.hasClass("drawing-board-control-colors-current")
              ? c
              : c.closest(".drawing-board-control-colors-current"),
            e = a.$el.find(".drawing-board-control-colors-current"),
            f = a.$el.find(".drawing-board-control-colors-rainbows");
          (d.length && d.get(0) === e.get(0)) ||
            f.hasClass("drawing-board-utils-hidden") ||
            f.addClass("drawing-board-utils-hidden");
        });
    },
    initTemplate: function () {
      var a =
          '<div class="drawing-board-control-inner"><div class="drawing-board-control-colors-current" style="background-color: {{color}}" data-color="{{color}}"></div><div class="drawing-board-control-colors-rainbows">{{rainbows}}</div></div>',
        b =
      ...
      $.each(
        ...
        $.proxy(function (a, d) {
          ...
          for (
            c += '<div class="drawing-board-control-colors-rainbow">',
              0.25 == d && (f = this._rgba(0, 0, 0, 1)),
              0.5 == d && (f = this._rgba(150, 150, 150, 1)),
              0.75 == d && (f = this._rgba(255, 255, 255, 1)),
              c += DrawingBoard.Utils.tpl(b, { color: f.toString() });
            330 >= e;

          )
            (c += DrawingBoard.Utils.tpl(b, {
        ...
        this.$el.append(
          $(DrawingBoard.Utils.tpl(a, { color: this.board.color, rainbows: c }))
        ),
        this.$el
          .find(".drawing-board-control-colors-rainbows")
          .addClass("drawing-board-utils-hidden");
    ...
    _hsl2Rgba: function (a) {
      ...
      if (0 === g) c = d = e = h;
        ...
        var i = 0.5 > h ? h * (1 + g) : h + g - h * g,
          j = 2 * h - i;
        (c = Math.floor(255 * b(j, i, f + 1 / 3))),
          (d = Math.floor(255 * b(j, i, f))),
          (e = Math.floor(255 * b(j, i, f - 1 / 3)));
      }
  ...
  (DrawingBoard.Control.DrawingMode = DrawingBoard.Control.extend({
    name: "drawingmode",
    defaults: { pencil: !0, eraser: !0, filler: !0 },
    initialize: function () {
  ...
  (DrawingBoard.Control.Navigation = DrawingBoard.Control.extend({
    name: "navigation",
    defaults: { back: !0, forward: !0, reset: !0 },
    initialize: function () {
      var a = "";
      if (
        (this.opts.back &&
          (a +=
            '<button class="drawing-board-control-navigation-back">&larr;</button>'),
        this.opts.forward &&
          (a +=
            '<button class="drawing-board-control-navigation-forward">&rarr;</button>'),
        this.opts.reset &&
          (a +=
            '<button class="drawing-board-control-navigation-reset">&times;</button>'),
        this.$el.append(a),
        this.opts.back)
      ) {
      ...
      if (this.opts.forward) {
        ...
        this.board.ev.bind(
          "historyNavigation",
          $.proxy(this.updateForward, this, c)
        ),
          this.$el.on(
            "click",
      ...
      this.opts.reset &&
        this.$el.on(
          ...
          $.proxy(function (a) {
            this.board.reset({ background: !0 }), a.preventDefault();
          }, this)
        );
    },
    updateBack: function (a) {
      this.board.history.canUndo()
        ? a.removeAttr("disabled")
        : a.attr("disabled", "disabled");
    },
    updateForward: function (a) {
      this.board.history.canRedo()
        ? a.removeAttr("disabled")
        : a.attr("disabled", "disabled");
    },
  })),
  (DrawingBoard.Control.Size = DrawingBoard.Control.extend({
    ...
    _rangeTemplate: function () {
      var a =
        '<div class="drawing-board-control-inner" title="{{size}}"><input type="range" min="{{min}}" max="{{max}}" value="{{size}}" step="1" class="drawing-board-control-size-range-input"><span class="drawing-board-control-size-range-current"></span></div>';
    ...
    _dropdownTemplate: function () {
      var a =
        '<div class="drawing-board-control-inner" title="{{size}}"><div class="drawing-board-control-size-dropdown-current"><span></span></div><ul class="drawing-board-control-size-dropdown">';
      return (
        $.each(this.opts.dropdownValues, function (b, c) {
          a += DrawingBoard.Utils.tpl(
    ...
    _iHasRangeInput: function () {
      ...
      return (
        ...
        /^range$/.test(e) &&
          void 0 !== b.style.WebkitAppearance &&
          (d.appendChild(b),
          (defaultView = document.defaultView),
          (a =
            defaultView.getComputedStyle &&
            "textfield" !==
              defaultView.getComputedStyle(b, null).WebkitAppearance &&
            0 !== b.offsetHeight),
          d.removeChild(b)),
        !!a
      );
  ...
  (DrawingBoard.Control.Download = DrawingBoard.Control.extend({
    ...
    initialize: function () {
      this.$el.append(
        '<button class="drawing-board-control-download-button"></button>'
      ),
        this.$el.on(
          "click",
